# apostille-me-monorepo (superseded)

> This repository is frozen. The canonical source of truth is [`apme-monorepo`](https://github.com/apostille-me/apme-monorepo).
...
- Open issues, pull requests, releases, and new work in `apostille-me/apme-monorepo`.
